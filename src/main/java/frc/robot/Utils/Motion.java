...
public class Motion {
    ...
    {
        Trajectory left_trajectory = PathfinderFRC.getTrajectory(Constants.k_path_nameL + ".left");
        Trajectory right_trajectory = PathfinderFRC.getTrajectory(Constants.k_path_nameR + ".left");
        ...
        m_follower_notifier = new Notifier(followPath());
    ...
    public static Runnable followPath()
    {
        return new Runnable(){
            @Override
            public void run() {
